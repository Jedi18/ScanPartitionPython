...
def readCsv():
    ...
    with open('C:\\Users\\targe\\Documents\\hpx\\build\\examples\\quickstart\\exclusiveOutputAlter.csv') as csvfile:
        ...
        for row in valueReader:
            ...
            value_dict[chunk_key].append([int(row[0]), int(row[3]), int(row[4])])
